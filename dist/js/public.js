...
class indexHtml {
    ...
    init() {
        this.$Navigation.load('/dist/html/public.html #p-Navigation', function () {
            class Popup {
                constructor() {
                    //获取登陆按钮
                    this.$login = $('.login');
        ...
        this.$Search.load('/dist/html/public.html #p-Search', function () {
...
new indexHtml();
(function(){
    let left = $('#Search .input').offset();
    let txt = $('#Search .input input');
    let $ul = $('ul.jsonp');
    $ul.css({
        "display":"none",
        "position": "absolute",
